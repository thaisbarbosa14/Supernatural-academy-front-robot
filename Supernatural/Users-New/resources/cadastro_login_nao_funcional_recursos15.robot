...
Verificar se será apresentada a mensagem informando que o campo Confirma Senha é obrigatório
     Page Should Contain    O campo de confirmação de senha é obrigatório.
     Capture Element Screenshot   //div[@class='MuiAlert-message css-1xsto0d'][contains(.,'O campo de confirmação de senha é obrigatório.')]
