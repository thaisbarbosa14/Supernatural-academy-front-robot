...
${SALVAR}                 id=save
${MENSAGEM_VALIDACAO}      Informe o nome e sobrenome com as iniciais em letra maiúscula e sem caracteres especiais
...
Clicar no menu Cadastros
       Wait Until Element Is Visible    ${SELETOR_MENUS_CADASTROS}    6s  
       sleep  3s
